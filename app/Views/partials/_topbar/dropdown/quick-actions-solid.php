...
<div class="kt-grid-nav">
	<a href="<?= base_url('dashboard');?>" class="kt-grid-nav__item">
	...
	<a href="<?= base_url('user-control');?>" class="kt-grid-nav__item">
		<div class="kt-grid-nav__item-icon"><i class="flaticon-settings"></i></div>
		<div class="kt-grid-nav__item-title">User Control</div>
		<div class="kt-grid-nav__item-desc">user management</div>
	</a>
</div>