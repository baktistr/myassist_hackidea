...
<div class="kt-header-menu-wrapper" id="kt_header_menu_wrapper">
	...
	<div class="kt-menu__nav ">
		<div class="kt-menu__item kt-menu__item--submenu kt-menu__item--rel <?= $subheader == 'Dashboard' ? 'kt-menu__item--here' : ''; ?>">
		...
		<div class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel">
			<a href="<?= base_url('/#');?>" class="kt-menu__link "><span class="kt-menu__link-text">API Documentation</span></a>
		</div>
	</div>	
